<!-- Modal -->
<div wire:ignore.self class="modal fade" id="viewFeedbackModal" tabindex="-1" aria-labelledby="viewFeedbackModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="viewFeedbackModalLabel" style="color: black; text-align:center">Feedback Form</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form wire:submit.prevent="viewFeedback" action="">
            <div class="modal-body" style="color: black">
                ...
                <div class="row" style="margin-top:10px">
                    ...
                    <div class="col" style="display: flex;margin-left: 80px">
                        ...
                        <div class="col">
                            ...
                            <textarea disabled style="color: black; background-color: transparent;" wire:model="compliments" class="form-control" cols="10" rows="3"></textarea>
                        </div>
                    </div>
                ...
                <div class="row" style="margin-top:10px">
                    ...
                    <div class="col" style="display: flex;margin-left: 80px">
                        ...
                        <div class="col"><textarea disabled style="color: black; background-color: transparent;" wire:model="complaints" class="form-control" cols="10" rows="3"></textarea>
                        </div>
                    </div>
                ...
                <div class="row" style="margin-top:10px">
                    ...
                    <div class="col" style="display: flex;margin-left: 80px">
                        ...
                        <div class="col">
                            <textarea disabled style="color: black; background-color: transparent;" wire:model="suggestions" class="form-control" cols="10" rows="3"></textarea>
                        </div>
                    </div>
