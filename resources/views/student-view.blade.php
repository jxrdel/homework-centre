...
@section('content')
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800" style="margin: auto"><strong><i class="fa-solid fa-baby"></i> &nbsp; {{$student->FirstName}} {{$student->LastName}}</strong></h1>
        </div>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                      <div class="card" style="margin-top:10px; padding-left:20px;min-height:180px;border:none">
                          ...
                          <div class="col-md-4">
                              <div style="display: flex; justify-content: center; align-items: center;">
                                  <img style="max-height: 180px;width:auto;" src="{{ Storage::url($parent->PicturePath) }}" width="150" height="150" class="img-fluid rounded" alt="...">
                              </div>
                          </div>
                          <div class="col-md-8">
                              <div class="card-body">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                      <div class="card" style="margin-top:10px; padding-left:20px;min-height:180px;border:none">
                          ...
                          <div class="col-md-4">
                              <div style="display: flex; justify-content: center; align-items: center;">
                                  <img style="max-height: 180px;width:auto;" src="{{ Storage::url($emergencycontact->PicturePath) }}" width="150" height="150" class="img-fluid rounded" alt="...">
                              </div>
                          </div>
                          <div class="col-md-8">
                              <div class="card-body">
